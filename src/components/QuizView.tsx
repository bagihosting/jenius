    ...
    return (
        <Card className="bg-primary/10 border-primary/20">
            <CardHeader>
                ...
                <CardDescription>Buat kuis acak dengan AI untuk menguji pengetahuanmu tentang materi ini.</CardDescription>
            </CardHeader>
            <CardFooter>
  ...
  if (quizState === 'loading') {
    return (
      <div className="flex flex-col items-center justify-center text-center p-8 rounded-lg bg-secondary">
        ...
        <p className="font-semibold text-lg">AI sedang menyiapkan kuis...</p>
