  ...
  return (
    <div className="flex flex-col min-h-screen bg-background text-foreground">
      ...
      <main className="flex-grow">
        <section className="container mx-auto px-4 py-16 md:py-24 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="mt-8 flex justify-center gap-4">
              ...
              <Button size="lg" variant="ghost" className="h-12 text-lg" onClick={() => router.push('/login')}>
                Sudah Punya Akun?
              </Button>
            </div>
          </div>
        ...
        {/* Features Section */}
        <section id="features" className="bg-secondary/40 py-16 md:py-24">
          <div className="container mx-auto px-4">
            ...
            <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8">
              {features.map((feature) => (
                <Card key={feature.title} className="text-center shadow-lg hover:shadow-xl hover:-translate-y-1 transition-transform duration-300">
                  <CardHeader>
        ...
        {/* How It Works Section */}
         <section className="py-16 md:py-24">
            <div className="container mx-auto px-4">
                ...
                <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8 text-center relative">
                    ...
                    <div className="flex flex-col items-center z-10">
                        ...
                        <h3 className="mt-4 text-xl font-semibold">Daftar Akun</h3>
                     ...
                     <div className="flex flex-col items-center z-10">
                        ...
                        <h3 className="mt-4 text-xl font-semibold">Pilih Kelas</h3>
                     ...
                     <div className="flex flex-col items-center z-10">
                        ...
                        <h3 className="mt-4 text-xl font-semibold">Mulai Belajar</h3>
        ...
        <section className="bg-secondary/40 py-16 md:py-24">
            <div className="container mx-auto px-4">
                <div className="max-w-3xl mx-auto text-center">
                    ...
                    <blockquote className="mt-6 text-xl md:text-2xl font-semibold italic">
